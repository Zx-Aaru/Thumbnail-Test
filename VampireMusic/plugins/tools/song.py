...
from VampireMusic.utils.formatters import convert_bytes
from VampireMusic.utils.inline.song import song_markup

mycookies = "VampireMusic/cookies.txt"
...
async def song_download_cb(client, CallbackQuery, _):
    ...
    with yt_dlp.YoutubeDL({"cookiefile": "VampireMusic/cookies.txt", "quiet": True}) as ytdl:
